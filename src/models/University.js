...
const universitySchema = new mongoose.Schema(
  {
    ...
    annualFeesSubtext: { type: String, default: "", trim: true, maxlength: 80 },
    medium:          { type: String, default: "" },
    hostelFees:      { type: String, default: "" },
    hostelFeesSubtext: { type: String, default: "", trim: true, maxlength: 80 },
    foodMealsCost:   { type: String, default: "", trim: true, maxlength: 140 },
    foodMealsCostSubtext: { type: String, default: "", trim: true, maxlength: 80 },
    insuranceCost:   { type: String, default: "", trim: true, maxlength: 140 },
    insuranceCostSubtext: { type: String, default: "", trim: true, maxlength: 80 },
    donationCost:    { type: String, default: "", trim: true, maxlength: 140 },
    donationCostSubtext: { type: String, default: "", trim: true, maxlength: 80 },
    totalYearCost:   { type: String, default: "", trim: true, maxlength: 140 },
    totalYearCostSubtext: { type: String, default: "", trim: true, maxlength: 80 },
